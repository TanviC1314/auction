  ...
  return (
    <div className="w-[1536px] h-[864px] bg-white">
      <div className="relative h-[864px]">
        <div className="absolute w-[1536px] h-[864px] top-0 left-0 bg-[url(clip-path-group.png)] bg-[100%_100%]">
          <div className="relative h-[864px]">
            <img
            ...
            <img
              className="absolute w-[300px] h-[350px] top-14 left-[580px] rounded-lg"
              alt="Clip path group"
